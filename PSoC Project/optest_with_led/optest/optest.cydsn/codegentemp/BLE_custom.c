...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* adc_read service */
    {
        0x0010u, /* Handle of the adc_read service */ 
        {

            /* adc_read_data characteristic */
            {
                0x0012u, /* Handle of the adc_read_data characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0013u, /* Handle of the adc_readcccd descriptor */ 
