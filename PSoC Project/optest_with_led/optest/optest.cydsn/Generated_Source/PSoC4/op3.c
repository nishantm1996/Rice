...
uint8 op3_initVar = 0u; /* Defines if component was initialized */
static uint32 op3_internalPower = 0u; /* Defines component Power value */


/*******************************************************************************
* Function Name: op3_Init
********************************************************************************
*
* Summary:
...
void op3_Init(void)
{
    op3_internalPower = op3_POWER;
    op3_CTB_CTRL_REG = op3_DEFAULT_CTB_CTRL;
    op3_OA_RES_CTRL_REG = op3_DEFAULT_OA_RES_CTRL;
    op3_OA_COMP_TRIM_REG = op3_DEFAULT_OA_COMP_TRIM_REG;
}


/*******************************************************************************
* Function Name: op3_Enable
********************************************************************************
*
* Summary:
...
{
    op3_OA_RES_CTRL_REG |= op3_internalPower | \
                                        op3_OA_PUMP_EN;
}


/*******************************************************************************
* Function Name: op3_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  op3_initVar: Used to check the initial configuration, modified
...
void op3_Stop(void)
{
    op3_OA_RES_CTRL_REG &= ((uint32)~(op3_OA_PWR_MODE_MASK | \
                                                   op3_OA_PUMP_EN));
}


/*******************************************************************************
* Function Name: op3_SetPower
********************************************************************************
*
* Summary:
...
* Parameters:
*  power: power levels.
*   op3_LOW_POWER - Lowest active power
*   op3_MED_POWER - Medium power
*   op3_HIGH_POWER - Highest active power
*
* Return:
*  None
*
...
void op3_SetPower(uint32 power)
{
    ...
    op3_internalPower = op3_GET_OA_PWR_MODE(power);
    tmp = op3_OA_RES_CTRL_REG & \
           (uint32)~op3_OA_PWR_MODE_MASK;
    op3_OA_RES_CTRL_REG = tmp | op3_internalPower;
}


/*******************************************************************************
* Function Name: op3_PumpControl
********************************************************************************
*
* Summary:
...
*   op3_PUMP_OFF - Turn off the pump
*   op3_PUMP_ON - Turn on the pump
*
* Return:
*  None
*
...
void op3_PumpControl(uint32 onOff)
{
    ...
    if(0u != onOff)
    {
        op3_OA_RES_CTRL |= op3_OA_PUMP_EN;    
    }
    else
    {
        op3_OA_RES_CTRL &= (uint32)~op3_OA_PUMP_EN;
    }
}
