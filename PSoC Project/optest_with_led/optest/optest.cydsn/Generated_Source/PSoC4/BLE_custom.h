...
#define CYBLE_ADC_READ_SERVICE_INDEX   (0x00u) /* Index of adc_read service in the cyBle_customs array */
#define CYBLE_ADC_READ_ADC_READ_DATA_CHAR_INDEX   (0x00u) /* Index of adc_read_data characteristic */
#define CYBLE_ADC_READ_ADC_READ_DATA_ADC_READCCCD_DESC_INDEX   (0x00u) /* Index of adc_readcccd descriptor */
#define CYBLE_ADC_READ_ADC_READ_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */
#define CYBLE_ADC_READ_LED_CHAR_INDEX   (0x01u) /* Index of led characteristic */
#define CYBLE_ADC_READ_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_ADC_READ_SERVICE_HANDLE   (0x0010u) /* Handle of adc_read service */
#define CYBLE_ADC_READ_ADC_READ_DATA_DECL_HANDLE   (0x0011u) /* Handle of adc_read_data characteristic declaration */
#define CYBLE_ADC_READ_ADC_READ_DATA_CHAR_HANDLE   (0x0012u) /* Handle of adc_read_data characteristic */
#define CYBLE_ADC_READ_ADC_READ_DATA_ADC_READCCCD_DESC_HANDLE   (0x0013u) /* Handle of adc_readcccd descriptor */
#define CYBLE_ADC_READ_ADC_READ_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0014u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_ADC_READ_LED_DECL_HANDLE   (0x0015u) /* Handle of led characteristic declaration */
#define CYBLE_ADC_READ_LED_CHAR_HANDLE   (0x0016u) /* Handle of led characteristic */
#define CYBLE_ADC_READ_LED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
